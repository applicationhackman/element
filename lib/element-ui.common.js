...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    handleMenuEvents: function handleMenuEvents(menuIndex, name, eventType) {
	  ...
	  computed: {
	    activeOptions: {
	      ...
	      get: function get() {
	        ...
	        var activeValue = this.activeValue;
	        var configurableProps = ['label', 'value', 'children', 'disabled', 'name', 'tagNameDescription'];
	  ...
	  render: function render(h) {
	    ...
	    var menus = this._l(activeOptions, function (menu, menuIndex) {
	      ...
	      createNewItemEvent.on.click = function () {
	        _this2.handleMenuEvents(menuIndex, name, 'add');
	      };
	      customizeMenuEvent.on.click = function () {
	        _this2.handleMenuEvents(menuIndex, name, 'customize');
	      };
	      editMenuEvent.on.click = function () {
	        _this2.handleMenuEvents(menuIndex, name, 'edit');
	      };
	      var menuStyle = {};
	      if (isFlat) {
	        menuStyle.minWidth = _this2.inputWidth + 'px';
