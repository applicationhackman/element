...
/***/ function(module, exports, __webpack_require__) {
	...
	var _index127 = __webpack_require__(361);

	var _index128 = _interopRequireDefault(_index127);

	var _index129 = __webpack_require__(379);
	...
	module.exports = {
	  ...
	  CascaderGroup: _index126.default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    handleMenuItemClick: function handleMenuItemClick(command, passback, instance) {
	      if (this.hideOnClick) {
	        this.visible = false;
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* istanbul ignore next */
	_main2.default.install = function (Vue) {
	  console.log('Cascader is here ', _main2.default);
	  Vue.component(_main2.default.name, _main2.default);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  computed: {
	    ...
	    headerKey: function headerKey() {
	      return this.props.header || 'header';
	    },
	    descriptionKey: function descriptionKey() {
	    ...
	    tagNameDescriptionKey: function tagNameDescriptionKey() {
	  ...
	  watch: {
	    enableMenuEvents: function enableMenuEvents(value) {
	  ...
	  methods: {
	    ...
	    handleMenuEvents: function handleMenuEvents(menuObject) {
	...
	exports.default = {
	  ...
	  computed: {
	    activeOptions: {
	      ...
	      get: function get() {
	        ...
	        var activeValue = this.activeValue;
	        var configurableProps = ['label', 'value', 'children', 'disabled', 'name', 'tagNameDescription', 'id'];
	  ...
	  render: function render(h) {
	    ...
	    var menus = this._l(activeOptions, function (menu, menuIndex) {
	      ...
	      var menuId = '';
	      var createNewItemEvent = {
	        on: {}
	      };
	      var customizeMenuEvent = {
	        on: {}
	      };
	      var editMenuEvent = {
	        on: {}
	      ...
	      createNewItemEvent.on.click = function () {
	        menuObject.type = 'add';
	        _this2.handleMenuEvents(menuObject);
	      };
	      customizeMenuEvent.on.click = function () {
	        menuObject.type = 'customize';
	        _this2.handleMenuEvents(menuObject);
	      };
	      editMenuEvent.on.click = function () {
	        ...
	        [h(
	          ...
	          [h(
	            ...
	            [h(
	              ...
	              [h(
	                'i',
	                { 'class': 'fa fa-pencil fa-lg c-icon p10' },
	                []
	              )]
	            )]
	          )]
	          ...
	          [h(
	            ...
	            [h(
	              'i',
	              { 'class': 'fa fa-cog fa-lg c-icon mr5' },
	              []
	            ), h(
	              'span',
	              { 'class': 'c-t2' },
	              ['Customize ', name, ' fields']
	            )]
	          ), h(
	            'div',
	            { 'class': 'p5' },
	            [items, h(
	              ...
	              [h(
	                'i',
	                { 'class': 'fa fa-plus-circle fa-lg c-green mr5' },
	                []
	              ), ' New ', name]
	            )]
	          )]
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _color = __webpack_require__(364);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _draggable = __webpack_require__(369);
